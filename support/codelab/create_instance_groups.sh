...
gcloud compute instance-groups managed set-autoscaling inpho-managed-group-eu --min-num-replicas 3 --max-num-replicas 8 --target-cpu-utilization 0.6 --cool-down-period 30 --region europe-west3
...
gcloud compute instance-groups managed set-autoscaling inpho-managed-group-us --min-num-replicas 3 --max-num-replicas 8 --target-cpu-utilization 0.6 --cool-down-period 30 --region us-east4