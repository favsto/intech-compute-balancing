...
echo "Furthermore, you need to run this command with an owner of the project intech-lab-01: "
...
gcloud compute instance-templates create "inpho-instance-template" \
  ...
  --metadata "sql-connection-name=intech17-group-$1:europe-west3:intech17,destination-bucket=inpho-group$1,sql-username=intech,sql-password=workshop2017,startup-script-url=gs://intech/startup.sh" \
